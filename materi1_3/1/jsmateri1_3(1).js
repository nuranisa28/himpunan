...
function penjelasan(evt, method) {
  var i, penjelasan, metode;
  penjelasan = document.getElementsByClassName("penjelasan");
  for (i = 0; i < penjelasan.length; i++) {
    penjelasan[i].style.display = "none";
  }
