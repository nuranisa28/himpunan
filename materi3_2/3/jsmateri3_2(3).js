...
//jawaban 1
let jawaban = document.querySelector('.input1');


// function agar saat di enter tidak dijalankan 
    jawaban.addEventListener('keypress', function (e) {
        if (e.keyCode == 13) {
            e.preventDefault();
            return false;
        }
  ...
  jawaban.addEventListener('keyup',function(){
    if(jawaban.value.length==0){
      if(jawaban.className.indexOf('boxhijau') == -1){
          jawaban.className = jawaban.className.replace('boxmerah', "");
        }
        if (jawaban.className.indexOf('boxmerah') == -1){
          jawaban.className = jawaban.className.replace('boxhijau', "");
        } 
    ...
    if(jawaban.value.length==1){
      ...
      if(jawaban.value==2){
        ...
        if (jawaban.className.indexOf('boxhijau') == -1) {
          if (jawaban.className.indexOf('boxmerah') == -1) {
            jawaban.className += ' boxhijau';
          } else {
            jawaban.className = jawaban.className.replace('boxmerah', 'boxhijau');
          }
        }
        ...
        if (jawaban.className.indexOf('boxmerah') == -1) {
          if (jawaban.className.indexOf('boxhijau') == -1) {
            jawaban.className += ' boxmerah';
          } else {
            jawaban.className = jawaban.className.replace('boxhijau', 'boxmerah');
          }
        }
  ...
  if(jawab4.value.length!=0){
    ...
    if(jawab4.value.match(alpha)){
      //box warna
        ...
        document.getElementById('ket4').innerHTML = "<br>Ups! Jawabanmu mengandung huruf! Silahkan ulangi jawaban."
